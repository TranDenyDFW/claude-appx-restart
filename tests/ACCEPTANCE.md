...
| An event log that cannot be read is an error, never no events, so a launch reports VISIBLE rather than GREEN, a trace cannot report CLEAR, an event-triggered run does not report NO ACTION, and no error dialog is closed | tests/test_events.py::test_a_denied_log_is_an_error_not_an_empty_answer, tests/test_events.py::test_a_missing_log_is_an_error_even_though_it_is_also_not_found, tests/test_events.py::test_a_disabled_log_is_an_error_whether_or_not_it_holds_records, tests/test_events.py::test_a_log_whose_state_cannot_be_read_is_an_error, tests/test_events.py::test_a_query_the_real_log_throws_on_is_an_error, tests/test_events.py::test_an_error_with_nothing_read_is_an_error, tests/test_events.py::test_a_query_that_matched_nothing_is_no_events, tests/test_events.py::test_the_real_log_is_read_without_error, tests/test_dialogs.py::test_an_event_log_that_cannot_be_read_leaves_the_dialog_open, tests/test_cli.py::test_an_event_triggered_run_reports_the_error_instead_of_no_action, tests/test_cli.py::test_a_trace_reports_the_error_instead_of_clear, tests/test_dialogs.py::test_visible_without_an_event_check_leaves_them_open |
| One event record that cannot be read does not hide the records a trace read, and fails the check after a launch | tests/test_events.py::test_a_trace_keeps_the_records_it_read_beside_one_it_could_not, tests/test_events.py::test_the_post_launch_check_fails_on_any_record_it_could_not_read |
